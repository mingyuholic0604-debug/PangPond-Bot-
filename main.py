...
class PangpondBot(commands.Bot):
    ...
    async def on_ready(self):
        setup_database()
        # Optional: Sync slash commands on startup
...
async def balance(interaction: discord.Interaction):
    ...
    if not res: return await interaction.response.send_message("❌ Error loading balance.")
...
async def profile_cmd(interaction: discord.Interaction, user: discord.Member = None):
    ...
    if not res: return await interaction.response.send_message("❌ Error loading profile.")
